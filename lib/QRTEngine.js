<script>
        ...
        showStimulusQuestion: function(question) {
            ...
            if (question.conditional() === true) {
                ...
                if (question.onKeyPress !== undefined || question.questionElement.allowable !== '' || question.questionElement.cresp !== '') {
                    ...
                    QRTE.setTrialData(question.questionElement.QRTLibId + '[RTTime]', RTT''ime);
    ...
    //If preview mode is run (PreviewBanner element exists, add a QRTEngine plug with id QRTEngine)
    ...
    if($('PreviewBanner')) {
        ...
        plug.id = "QRTEPlug";
        plug.width = "20%";
        plug.innerHTML = "This survey is proudly and successfully powered by <a href=\"http://qrt.pikzel.nl\" target=\"_blank\"><i><b>QRTEngine</b></i></a>"
