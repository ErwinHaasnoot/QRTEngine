<script>
    ...
    var QRTE = {
        ...
        startTrial: function(startId) {
            ...
            console.log('${lm://CurrentLoopNumber}' , '${lm://TotalLoops}');
            var currentLoops = '${lm://CurrentLoopNumber}', totalLoops = '${lm://TotalLoops}';
    ...
    if (typeof QRTEController == 'undefined') {
        ...
        QRTEController = {
            ...
            init: function() {
                ...
                console.log(this, this.currentForm, $$('form'));
