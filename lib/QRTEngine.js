<script>
     ...
     *
     * http://www.apache.org/licenses/_jLICENSE-2.0
     *
    ...
    var QRTE = {
        ...
        waitForKey: function(question, keys) {
            var handler = function(e) {
                ...
                if (keys.indexOf(resp) >= 0) {
                    document.stopObserving('keypress',handler);
                    question.clickNextButton();
                }
            }
            Event.observe(document, 'keypress', handler);
        },
        ...
        displayElement: function(paramObj) {
            ...
            QRTE.log('paramObj: ', paramObj.userId, ', duration: ', paramObj.duration);
